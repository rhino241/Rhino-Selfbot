...
def random_cooldown(minimum, maximum):
    min_int = int(minimum * 100000)  # Convert minimum to integer
    max_int = int(maximum * 100000)  # Convert maximum to integer
    cooldown = random.randint(min_int, max_int) / 100000
    return cooldown
