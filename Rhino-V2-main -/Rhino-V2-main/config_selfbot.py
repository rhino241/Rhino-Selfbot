...
# en: SelfBot name
# fr: Nom du SelfBot
selfbot_name = "Rhino" # Tip: Don't use the "Selfbot" word into your selfbot name, most of servers blacklist this word with AutoMod
...
ban_reason = "ezzed by Rhino lol."
kick_reason = "ezzed by Rhino lol."
...
activity_button_one = "Rhino !"
activity_button_one_answer = "https://github.com/rhino241/Rhino-Selfbot" # doesn't work for the moment
activity_button_two = "Star it!"
activity_button_two_answer = "https://github.com/rhino241/Rhino-Selfbot" # doesn't work for the moment

# see &tuto
#icon = rpc.get_raw_json("Rhino", "Rhino-V2", "assets.json")
